    ...
    private var ForeacastMenue: some View {
        VStack {
            ...
            HStack {
                ...
                MenueButton(prefId: $prefId, prefName: $prefName, imageName: "hokkaidou", title: "十勝", id: "014100")
            }
            HStack {
                MenueButton(prefId: $prefId, prefName: $prefName, imageName: "hokkaidou", title: "釧路・根室", id: "014100")
                MenueButton(prefId: $prefId, prefName: $prefName, imageName: "hokkaidou", title: "胆振・日高", id: "015000")
            }
            HStack {
            ...
            HStack {
                MenueButton(prefId: $prefId, prefName: $prefName, imageName: "kagoshima", title: "奄美", id: "460100")
            }
            Divider()
            Text("沖縄")
                .font(.title)
